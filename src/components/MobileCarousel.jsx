  ...
  return (
    ...
    >
      ...
      <div className="w-full flex flex-col items-center justify-center py-12 border-black/10">
        ...
        <button onClick={() => location.href = "https://pages.shreyauxfolio.net/expertise_v1#section1"} className="bg-black text-white px-6 py-3 rounded-full text-xs tracking-wider">
          Read All →
        </button>
      </div>
      ...
      <div className="w-full flex flex-col items-center justify-center py-12 border-black/10">
        ...
        <button onClick={() => location.href = "https://pages.shreyauxfolio.net/expertise_v1#section3"} className="bg-black text-white px-6 py-3 rounded-full text-xs tracking-wider">
          Read All →
        </button>
      </div>
      ...
      <div className="w-full flex flex-col items-center justify-center py-12 border-black/10">
        ...
        <button onClick={() => location.href = "https://pages.shreyauxfolio.net/expertise_v1#section4"} className="bg-black text-white px-6 py-3 rounded-full text-xs tracking-wider">
          Read All →
        </button>
      </div>
      ...
      <div className="w-full flex flex-col items-center justify-center py-12 border-black/10">
        ...
        <button onClick={() => location.href = "https://pages.shreyauxfolio.net/expertise_v1#section5"} className="bg-black text-white px-6 py-3 rounded-full text-xs tracking-wider">
          Read All →
        </button>
      </div>
